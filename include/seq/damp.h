...
// ufield, PCG
SEQ_ROUTINE
inline void dmpthole2_a(real r, real pgamma, real pdi, real pdk,
...
// dfield
SEQ_ROUTINE
inline void dmpthole3_a(real r, real pgamma, real pdi, real pdk,
...
SEQ_ROUTINE
inline void dmpthole3g_a(real r, real rr2, real xr, real yr, real zr,
   real pgamma, real pdi, real pdk, real& restrict scale31,
   real& restrict scale51, real& restrict scale71, real& restrict rc31,
   real& restrict rc32, real& restrict rc33, real& restrict rc51,
   real& restrict rc52, real& restrict rc53, real& restrict rc71,
   real& restrict rc72, real& restrict rc73)
{
   real damp = pdi * pdk;
   real ratio = r * REAL_RECIP(damp);
   damp = (damp == 0 ? ((real)1.0e16) : pgamma * ratio * ratio * ratio);
...
inline void damp_thole3g(real r, real rr2, real xr, real yr, real zr, real pdi,
   real pti, real pdk, real ptk, real& restrict scale31, real& restrict scale51,
...
{
   real pgamma = REAL_MIN(pti, ptk);
   dmpthole3g_a(r, rr2, xr, yr, zr, pgamma, pdi, pdk, scale31, scale51, scale71,
      rc31, rc32, rc33, rc51, rc52, rc53, rc71, rc72, rc73);
}

SEQ_ROUTINE
inline void dmpthole4_a(real r, real pgamma, real pdi, real pdk,
   real& restrict ex3, real& restrict ex5, real& restrict ex7,
   real& restrict ex9)
{
   real damp = pdi * pdk;
   real ratio = r * REAL_RECIP(damp);
