...
void pair_polar(                                                              //
   ...
   real qizz, real uix, real uiy, real uiz, real uixp, real uiyp, real uizp, real pdi, real pti, //
   real ck, real dkx, real dky, real dkz, real qkxx, real qkxy, real qkxz, real qkyy, real qkyz,
   real qkzz, real ukx, real uky, real ukz, real ukxp, real ukyp, real ukzp, real pdk, real ptk, //
