...
namespace tinker {
SEQ_ROUTINE
inline void chkpoleAtomI(int i, real (*restrict pole)[MPL_TOTAL], LocalFrame* zaxis,
...
SEQ_ROUTINE
inline void rotsite(int isite, const real (*restrict a)[3], real (*restrict rpole)[10],
