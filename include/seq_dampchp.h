...
template <int ORDER, class PENTYP>
SEQ_CUDA
                      ...
                      real* restrict dmpk, real r, real alphai, real alphak)
{
            ...
            dmpik[5] = 1 -
               ...
               termk2 *
                  (1 + dampk + 0.5f * dampk2 + dampk3 * div6 +
                   5 * dampk4 * div126 + 2 * dampk5 * div315 +
                   dampk6 * div1890) *
                  expk -
               2 * termi2 * termk *
                  ...
                  expi -
               2 * termi2 * termk *
                  (1 + dampi + (4 * dampk2 + dampk3) * div9 + dampk4 * div63 +
                   dampk5 * div945) *
                  expk;
         }
      }
   ...
   if CONSTEXPR (eq<PENTYP, GORDON2>()) {
      ...
      if (diff < eps) {
         ...
         dmpik[1] = 1 - termi * (1 + dampi) * expi - termk * (1 + dampk) * expk;
         dmpik[2] = 1 - termi * (1 + dampi + dampi2 * div3) * expi -
