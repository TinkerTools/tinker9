...
inline void image_null(real& __restrict__, real& __restrict__,
                       real& __restrict__, const Box* __restrict__) {}

#pragma acc routine seq
inline void imagen_null(real& __restrict__, real& __restrict__,
                        real& __restrict__, const Box* __restrict__) {}

#pragma acc routine seq
inline void image_orthogonal(real& __restrict__ xr, real& __restrict__ yr,
...
#pragma acc routine seq
inline void imagen_orthogonal(real& __restrict__ xr, real& __restrict__ yr,
                              real& __restrict__ zr,
                              const Box* __restrict__ pb) {
  real lx = pb->lvec[0][0];
  real lx2 = lx * 0.5f;
...
#pragma acc routine seq
inline void image_monoclinic(real& __restrict__ xr, real& __restrict__ yr,
                             real& __restrict__ zr,
                             const Box* __restrict__ pb) {
...
#pragma acc routine seq
inline void imagen_monoclinic(real& __restrict__ xr, real& __restrict__ yr,
                              real& __restrict__ zr,
                              const Box* __restrict__ pb) {
...
#pragma acc routine seq
inline void image_triclinic(real& __restrict__ xr, real& __restrict__ yr,
...
#pragma acc routine seq
inline void imagen_triclinic(real& __restrict__ xr, real& __restrict__ yr,
                             real& __restrict__ zr,
                             const Box* __restrict__ pb) {
  // TODO: a real imagen routine
...
#pragma acc routine seq
inline void image_general(real& __restrict__ xr, real& __restrict__ yr,
                          real& __restrict__ zr, const Box* __restrict__ pb) {
  switch (pb->shape) {
  case Box::ortho:
...
#pragma acc routine seq
inline void imagen_general(real& __restrict__ xr, real& __restrict__ yr,
                           real& __restrict__ zr, const Box* __restrict__ pb) {
  switch (pb->shape) {
  case Box::ortho:
 ...
 * \def image
 * \ingroup macro
 * Apply periodic boundary conditions to displacements (\c xr, \c yr, \c zr) and
 ...
 * \def imagen
 * \ingroup macro
 * Apply periodic boundary conditions to displacements (\c xr, \c yr, \c zr) but
