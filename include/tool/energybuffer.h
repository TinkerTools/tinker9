...
using count_buffer = pointer<count_buffer_traits::type, count_buffer_traits::value>;
using energy_buffer = pointer<energy_buffer_traits::type, energy_buffer_traits::value>;
using virial_buffer = pointer<virial_buffer_traits::type, virial_buffer_traits::value>;

void buffer_allocate(int flag, energy_buffer*, virial_buffer*, //
   grad_prec**, grad_prec**, grad_prec**);
void buffer_deallocate(int flag, energy_buffer, virial_buffer, grad_prec*, grad_prec*, grad_prec*);
 ...
 * \ingroup mdegv
 */
void virial_reshape(virial_prec (&output)[9], const virial_prec (&input)[virial_buffer_traits::N]);
/**
 * \ingroup mdegv
 * \see count_reduce
 */
void virial_reduce(virial_prec (&)[virial_buffer_traits::N], const virial_buffer b);
/**
 * \ingroup mdegv
 * \see count_reduce
 */
