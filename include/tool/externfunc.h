...
#define TINKER_FCALL2_acc0_cu1__(F, ...) TINKER_FCALL0_NORMAL_(F, cu, __VA_ARGS__)
#define TINKER_FCALL2_acc1_cu0__(F, ...) TINKER_FCALL0_NORMAL_(F, acc, __VA_ARGS__)
#define TINKER_FCALL2_acc1_cu1__(F, ...) \
   (pltfm_config & Platform::CUDA) ? TINKER_FCALL0_NORMAL_(F, cu, __VA_ARGS__) : TINKER_FCALL0_NORMAL_(F, acc, __VA_ARGS__)

#define TINKER_FCALL2_cpp0_cu1__(F, ...) TINKER_FCALL0_NORMAL_(F, cu, __VA_ARGS__)
...
#define TINKER_FCALL2_acc1_cu1__(F, ...) TINKER_FCALL0_NORMAL_(F, cu, __VA_ARGS__)
...
#define TINKER_FCALL2_acc1_cu0__(F, ...) TINKER_FCALL0_NORMAL_(F, acc, __VA_ARGS__)
#define TINKER_FCALL2_acc1_cu1__(F, ...) TINKER_FCALL0_NORMAL_(F, acc, __VA_ARGS__)
...
#define TINKER_FVOID2(SUFFIX_HAS_IMPL1, SUFFIX_HAS_IMPL2, FUNC, ...) TINKER_FEXTN2__(SUFFIX_HAS_IMPL1, SUFFIX_HAS_IMPL2, void, FUNC, __VA_ARGS__)
...
#define TINKER_FCALL2(SUFFIX_HAS_IMPL1, SUFFIX_HAS_IMPL2, FUNC, ...) TINKER_FCALL2_##SUFFIX_HAS_IMPL1##_##SUFFIX_HAS_IMPL2##__(FUNC, __VA_ARGS__)
