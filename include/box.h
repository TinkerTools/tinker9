...
void set_recip_box(real3&, real3&, real3&, BoxShape, const real3&, const real3&, const real3&);
void set_default_recip_box();
void get_box_axes_angles(
   const Box&, double& a, double& b, double& c, double& alpha, double& beta, double& gamma);
