...
TEST_CASE("External-Fields-2-Analyze", "[ff][extfield]") {}

TEST_CASE("External-Fields-3-Analyze", "[ff][extfield]") {}
...
TEST_CASE("External-Fields-2", "[ff][extfield]") {}

TEST_CASE("External-Fields-3", "[ff][extfield]") {}
