...
void LogVPropagator::updateVelocityImpl(time_prec t, int idx, int nrespa)
{
   ...
   //          if (nresp == 1)
   //             md::vel_avbf_ani(1, a, b, gx, gy, gz, nullptr, nullptr,
   //             nullptr);
   //          else
   //             md::vel_avbf_ani(nresp, a, b, gx1, gy1, gz1, gx2, gy2, gz2);
   //       } else {
   //          double al = 1.0 + 3.0 / dofP;
   //          double vt = al * vbar * t;
   //          double vt2 = vt * 0.5;
   ...
   //          if (nresp == 1)
   //             md::vel_avbf_iso(1, a, b, gx, gy, gz, nullptr, nullptr,
   //             nullptr);
   //          else
   //             md::vel_avbf_iso(nresp, a, b, gx1, gy1, gz1, gx2, gy2, gz2);
   //       }
   //    } else {
   //       if (idx == 1)
