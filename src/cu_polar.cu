...
__global__
void epolar_cu3(real* restrict trqx, real* restrict trqy, real* restrict trqz,
                int n, const real (*restrict rpole)[10],
                const real (*restrict ufld)[3], const real (*restrict dufld)[6])
{
