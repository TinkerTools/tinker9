...
template void symlusolve_acc<3, float>(const float*, float*);
template void symlusolve_acc<6, float>(const float*, float*);
template void symlusolve_acc<3, double>(const double*, double*);
template void symlusolve_acc<6, double>(const double*, double*);
}
