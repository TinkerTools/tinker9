...
#include "md.h"
#include "pmestuf.h"
#include "seq_pair_mpole_chgpen_aplus.h"
...
void empole_chgpen_aplus_acc1()
{
   ...
   for (int ii = 0; ii < nmdwexclude; ++ii) {
      ...
      if (r2 <= off2 and mscale != 0) {
         ...
         pair_mpole_chgpen_aplus<do_e, do_g, NON_EWALD, CFLX>(
            r2, xr, yr, zr, mscale,                 //
            ci, dix, diy, diz, corei, vali, alphai, //
            qixx, qixy, qixz, qiyy, qiyz, qizz,     //
            rpole[k][mpl_pme_0], rpole[k][mpl_pme_x], rpole[k][mpl_pme_y],
...
void empole_chgpen_aplus_nonewald_acc(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empole_chgpen_aplus_acc1<calc::V0, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_acc1<calc::V1, NON_EWALD, 1>();
      } else if (vers == calc::v3) {
         // empole_chgpen_aplus_acc1<calc::V3, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_acc1<calc::V4, NON_EWALD, 1>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_acc1<calc::V5, NON_EWALD, 1>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_acc1<calc::V6, NON_EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empole_chgpen_aplus_acc1<calc::V0, NON_EWALD, 0>();
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_acc1<calc::V1, NON_EWALD, 0>();
      } else if (vers == calc::v3) {
         empole_chgpen_aplus_acc1<calc::V3, NON_EWALD, 0>();
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_acc1<calc::V4, NON_EWALD, 0>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_acc1<calc::V5, NON_EWALD, 0>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_acc1<calc::V6, NON_EWALD, 0>();
      }
   }
}
...
void empole_chgpen_aplus_ewald_real_self_acc(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empole_chgpen_aplus_acc1<calc::V0, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_acc1<calc::V1, EWALD, 1>();
      } else if (vers == calc::v3) {
         // empole_chgpen_aplus_acc1<calc::V3, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_acc1<calc::V4, EWALD, 1>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_acc1<calc::V5, EWALD, 1>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_acc1<calc::V6, EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empole_chgpen_aplus_acc1<calc::V0, EWALD, 0>();
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_acc1<calc::V1, EWALD, 0>();
      } else if (vers == calc::v3) {
         empole_chgpen_aplus_acc1<calc::V3, EWALD, 0>();
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_acc1<calc::V4, EWALD, 0>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_acc1<calc::V5, EWALD, 0>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_acc1<calc::V6, EWALD, 0>();
      }
   }
}
