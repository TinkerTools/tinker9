...
void empole_chgpen_aplus_cu()
{
   ...
   empole_chgpen_aplus_cu1<Ver, ETYP, CFLX><<<ngrid, BLOCK_DIM, 0, g::s0>>>(
...
void empole_chgpen_aplus_nonewald_cu(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empole_chgpen_aplus_cu<calc::V0, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_cu<calc::V1, NON_EWALD, 1>();
      } else if (vers == calc::v3) {
         // empole_chgpen_aplus_cu<calc::V3, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_cu<calc::V4, NON_EWALD, 1>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_cu<calc::V5, NON_EWALD, 1>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_cu<calc::V6, NON_EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empole_chgpen_aplus_cu<calc::V0, NON_EWALD, 0>();
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_cu<calc::V1, NON_EWALD, 0>();
      } else if (vers == calc::v3) {
         empole_chgpen_aplus_cu<calc::V3, NON_EWALD, 0>();
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_cu<calc::V4, NON_EWALD, 0>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_cu<calc::V5, NON_EWALD, 0>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_cu<calc::V6, NON_EWALD, 0>();
      }
   }
}
...
void empole_chgpen_aplus_ewald_real_self_cu(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empole_chgpen_aplus_cu<calc::V0, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_cu<calc::V1, EWALD, 1>();
      } else if (vers == calc::v3) {
         // empole_chgpen_aplus_cu<calc::V3, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_cu<calc::V4, EWALD, 1>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_cu<calc::V5, EWALD, 1>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_cu<calc::V6, EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empole_chgpen_aplus_cu<calc::V0, EWALD, 0>();
      } else if (vers == calc::v1) {
         empole_chgpen_aplus_cu<calc::V1, EWALD, 0>();
      } else if (vers == calc::v3) {
         empole_chgpen_aplus_cu<calc::V3, EWALD, 0>();
      } else if (vers == calc::v4) {
         empole_chgpen_aplus_cu<calc::V4, EWALD, 0>();
      } else if (vers == calc::v5) {
         empole_chgpen_aplus_cu<calc::V5, EWALD, 0>();
      } else if (vers == calc::v6) {
         empole_chgpen_aplus_cu<calc::V6, EWALD, 0>();
      }
   }
}
}
