...
void empoleAplusNonEwald_cu(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empoleAplus_cu<calc::V0, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empoleAplus_cu<calc::V1, NON_EWALD, 1>();
      } else if (vers == calc::v3) {
         // empoleAplus_cu<calc::V3, NON_EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empoleAplus_cu<calc::V4, NON_EWALD, 1>();
      } else if (vers == calc::v5) {
         empoleAplus_cu<calc::V5, NON_EWALD, 1>();
      } else if (vers == calc::v6) {
         empoleAplus_cu<calc::V6, NON_EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empoleAplus_cu<calc::V0, NON_EWALD, 0>();
      } else if (vers == calc::v1) {
         empoleAplus_cu<calc::V1, NON_EWALD, 0>();
      } else if (vers == calc::v3) {
         empoleAplus_cu<calc::V3, NON_EWALD, 0>();
      } else if (vers == calc::v4) {
         empoleAplus_cu<calc::V4, NON_EWALD, 0>();
      } else if (vers == calc::v5) {
         empoleAplus_cu<calc::V5, NON_EWALD, 0>();
      } else if (vers == calc::v6) {
         empoleAplus_cu<calc::V6, NON_EWALD, 0>();
      }
   }
}
...
void empoleAplusEwaldRealSelf_cu(int vers, int use_cf)
{
   if (use_cf) {
      if (vers == calc::v0) {
         // empoleAplus_cu<calc::V0, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v1) {
         empoleAplus_cu<calc::V1, EWALD, 1>();
      } else if (vers == calc::v3) {
         // empoleAplus_cu<calc::V3, EWALD, 1>();
         assert(false && "CFLX must compute gradient.");
      } else if (vers == calc::v4) {
         empoleAplus_cu<calc::V4, EWALD, 1>();
      } else if (vers == calc::v5) {
         empoleAplus_cu<calc::V5, EWALD, 1>();
      } else if (vers == calc::v6) {
         empoleAplus_cu<calc::V6, EWALD, 1>();
      }
   } else {
      if (vers == calc::v0) {
         empoleAplus_cu<calc::V0, EWALD, 0>();
      } else if (vers == calc::v1) {
         empoleAplus_cu<calc::V1, EWALD, 0>();
      } else if (vers == calc::v3) {
         empoleAplus_cu<calc::V3, EWALD, 0>();
      } else if (vers == calc::v4) {
         empoleAplus_cu<calc::V4, EWALD, 0>();
      } else if (vers == calc::v5) {
         empoleAplus_cu<calc::V5, EWALD, 0>();
      } else if (vers == calc::v6) {
         empoleAplus_cu<calc::V6, EWALD, 0>();
      }
   }
}
}
