...
template <int bsorder>
__global__
void fphi_mpole_cu1(int n, int nfft1, int nfft2, int nfft3,
                    const real* restrict x, const real* restrict y,
                    const real* restrict z, real* restrict ptr1,
                    ...
                    real3 recip_c)
{
   ...
   real(*restrict fphi)[20] = (real(*)[20])ptr1;
...
void fphi_mpole_cu(PMEUnit pme_u, real* fphi)
{
   ...
   auto ker = fphi_mpole_cu1<5>;
   launch_kernel2(PME_BLOCKDIM, n, ker, n, n1, n2, n3, x, y, z, fphi, st.qgrid,
                  recip_a, recip_b, recip_c);
}
...
void pme_cuda_func_config()
{
   ...
   auto fphi_mpole = fphi_mpole_cu1<5>;
