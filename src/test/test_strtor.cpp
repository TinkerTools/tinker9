...
TEST_CASE("Strtor-A4", "[ff][estrtor][a4]")
{
   const char* k = "test_a4.key";
   const char* k0 = "strtorunit  10.0\n"
                    "strtorterm  only\n";
   ...
   TestFile fpr(TINKER9_DIRSTR "/src/test/file/commit_25b7ee7a/amoebanuc17.prm");

   TestReference r(TINKER9_DIRSTR "/src/test/ref/strtor.txt");
   ...
   COMPARE_INTS(nstrtor, ref_count);
