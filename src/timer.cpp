...
void Stopwatch::reset() { s_.clear(); }

static Stopwatch sw_;

void stopwatch_start() { sw_.start(); }

void stopwatch_lap(std::string log) { sw_.lap(log); }

void stopwatch_stop() { sw_.stop(); }

void stopwatch_reset() { sw_.reset(); }
