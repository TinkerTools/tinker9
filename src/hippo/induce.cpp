...
TINKER_FVOID2(cu, 1, acc, 1, sparsePrecondApply2, const real (*)[3], real (*)[3]);
...
namespace tinker {
TINKER_FVOID2(cu, 1, acc, 1, induceMutualPcg2, real (*)[3]);
static void induceMutualPcg2(real (*uind)[3])
{
   TINKER_FCALL2(cu, 1, acc, 1, induceMutualPcg2, uind);
}

TINKER_FVOID2(cu, 1, acc, 1, induceMutualPcg3, real (*)[3]);
static void induceMutualPcg3(real (*uind)[3])
{
   TINKER_FCALL2(cu, 1, acc, 1, induceMutualPcg3, uind);
}
